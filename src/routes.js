...
const ViewTransactions = React.lazy(() => import('./views/Trade/ViewTransactions'));
...
const routes = [
  ...
  { path: '/trade/view-transactions', exact: true, name: 'ViewTransactions', component: ViewTransactions },
